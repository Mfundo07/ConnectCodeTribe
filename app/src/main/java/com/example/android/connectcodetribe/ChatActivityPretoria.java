...
public class ChatActivityPretoria extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, View.OnClickListener, ClickListenerChatFirebase {
    ...
    static final String CHAT_REFERENCE = "chatModelPretoria";
    ...
    private void sendFileFirebase(StorageReference storageReference, final File file){
        if (storageReference != null){
            Uri photoURI = FileProvider.getUriForFile(ChatActivityPretoria.this,
    ...
    public void verifyStoragePermissions() {
        ...
        int permission = ActivityCompat.checkSelfPermission(ChatActivityPretoria.this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE);

        if (permission != PackageManager.PERMISSION_GRANTED) {
            // We don't have permission so prompt the user
            ActivityCompat.requestPermissions(
                    ChatActivityPretoria.this,
                    PERMISSIONS_STORAGE,
