...
public class ChatActivityAlexandra extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, View.OnClickListener, ClickListenerChatFirebase {
    ...
    static final String CHAT_REFERENCE = "chatModelAlexandra";
    ...
    private void sendFileFirebase(StorageReference storageReference, final File file){
        if (storageReference != null){
            Uri photoURI = FileProvider.getUriForFile(ChatActivityAlexandra.this,
    ...
    public void verifyStoragePermissions() {
        ...
        int permission = ActivityCompat.checkSelfPermission(ChatActivityAlexandra.this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE);

        if (permission != PackageManager.PERMISSION_GRANTED) {
            // We don't have permission so prompt the user
            ActivityCompat.requestPermissions(
                    ChatActivityAlexandra.this,
                    PERMISSIONS_STORAGE,
