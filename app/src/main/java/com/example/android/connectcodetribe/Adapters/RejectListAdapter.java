 ...
 */
public class RejectListAdapter extends RecyclerView.Adapter<RejectListAdapter.ViewHolder> {

      private List<TribeMate> mTribeMates;
      private List<Project> mProjects;

      public RejectListAdapter(List<Project> projects, Activity activity) {
        mProjects = projects;
      ...
      public RejectListAdapter(Activity activity, List<TribeMate> mTribeMates) {
             this.activity = activity;
