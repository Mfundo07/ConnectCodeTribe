 ...
 */
public class ChatActivityThembisa extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, View.OnClickListener, ClickListenerChatFirebase {
    ...
    private void sendFileFirebase(StorageReference storageReference, final File file){
        if (storageReference != null){
            Uri photoURI = FileProvider.getUriForFile(ChatActivityThembisa.this,
    ...
    public void verifyStoragePermissions() {
        ...
        int permission = ActivityCompat.checkSelfPermission(ChatActivityThembisa.this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE);

        if (permission != PackageManager.PERMISSION_GRANTED) {
            // We don't have permission so prompt the user
            ActivityCompat.requestPermissions(
                    ChatActivityThembisa.this,
                    PERMISSIONS_STORAGE,
