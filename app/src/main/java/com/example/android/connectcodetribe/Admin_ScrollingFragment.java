...
public class Admin_ScrollingFragment extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.admin_activity_scrolling);

        FloatingActionButton admin_fab = (FloatingActionButton)findViewById(R.id.admin_fab);
        admin_fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent kgomo =new Intent(Admin_ScrollingFragment.this,Admin_scrolling_editor.class);
                startActivity(kgomo);
            }
        });
